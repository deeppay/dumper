...
class DataProcessorTest extends FlatSpec with Matchers {
  ...
  "Data Processor" should "build INSERT command" in {
    ...
    val expected = List(
      "INSERT INTO datatest (channel,timestamp,value) VALUES ('t1',1420070401000,1.0);",
      "INSERT INTO datatest (channel,timestamp,value) VALUES ('t1',1420070402000,2.0);",
      "INSERT INTO datatest (channel,timestamp,value) VALUES ('t1',1420070403000,3.0);"
    )
